"""First revision, all models except Attachment

Revision ID: db7aa8ff0b9a
Revises: 
Create Date: 2025-11-21 02:00:33.314040
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('USER', 'ADMIN', 'MODERATOR', name='pparticipant_role'), nullable=False),
    sa.Column('created_at', app.core.database.TZDateTime(), nullable=False),
    sa.Column('updated_at', app.core.database.TZDateTime(), nullable=False),
    ...
    sa.Column('status', sa.Enum('BACKLOG', 'TO_DO', 'IN_RPOGRESS', 'TESTING', 'DONE', name='column_status'), nullable=False),
    ...
    sa.ForeignKeyConstraint(['assignee_id'], ['users.id'], name='fk_task_assignments_users_id', ondelete='CASCADE'),
